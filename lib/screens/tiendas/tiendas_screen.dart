...
class _TiendasScreenState extends State<TiendasScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          SectionHeader(
            ...
            title: 'Tiendas',
            subtitle: 'Gestiona las sucursales registradas',
            actionLabel: 'Nueva tienda',
            onActionPressed: () => _abrirFormTienda(context),
          ),
            ...
            child: prov.cargando
                ...
                : prov.tiendas.isEmpty
                    ? const EmptyStateCard(
                        ...
                        subtitle:
                            'Crea la primera tienda con el botón de arriba',
                      )
                    : RefreshIndicator(
  ...
  Widget _tiendaCard(BuildContext context, TiendaProvider prov, Tienda t) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: t.activo ? Colors.transparent : Colors.red.shade100,
        ),
        boxShadow: [
          BoxShadow(
  ...
  void _abrirFormTienda(BuildContext context, {Tienda? tienda}) {
    ...
    final direccionCtrl =
        TextEditingController(text: tienda?.direccion ?? '');
    final telefonoCtrl =
        TextEditingController(text: tienda?.telefono ?? '');
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                AppFormField(
                    label: 'Dirección', controller: direccionCtrl),
                AppFormField(
                    label: 'Teléfono',
                    controller: telefonoCtrl,
                    keyboardType: TextInputType.phone),
                AppFormField(label: 'Ciudad', controller: ciudadCtrl),
                AppFormField(label: 'NIT', controller: nitCtrl),
              ],
            ),
          ),
        ),
