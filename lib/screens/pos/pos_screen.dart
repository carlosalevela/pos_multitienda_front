...
class _PosScreenState extends State<PosScreen> {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 380, child: _buildCarrito(pos, auth)),
        ],
      ),
    );
  }
  ...
  Widget _buildProductList(PosProvider pos) {
    if (pos.buscando) return const Center(child: CircularProgressIndicator());
        ...
        Container(
          ...
          child: Row(children: [
            CircleAvatar(
              radius: 16,
              backgroundColor:
                  const Color(Constants.primaryColor).withOpacity(0.2),
              child: Text(
      ...
      child: Container(
        ...
        child: Row(children: [
          Icon(Icons.calendar_today_rounded,
              size: 16,
              color: _fechaLimite != null
                  ? const Color(Constants.primaryColor) : Colors.grey),
          const SizedBox(width: 8),
          Text(
            _fechaLimite != null
