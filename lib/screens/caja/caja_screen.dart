...
class _CajaScreenState extends State<CajaScreen> {
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                  caja.procesando ? 'Abriendo...' : 'Abrir Caja',
                  style: GoogleFonts.poppins(
              ...
              onPressed: caja.procesando
                  ...
                  : () => caja.abrirCaja(
                      ...
                      saldoInicial:
                          double.tryParse(_saldoCtrl.text) ?? 0),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                  caja.procesando ? 'Cargando...' : 'Cerrar Caja',
                  style: GoogleFonts.poppins(
                      fontWeight: FontWeight.w600, fontSize: 16)),
              onPressed:
                  caja.procesando ? null : () => _abrirCorteCaja(caja),
              style: ElevatedButton.styleFrom(
  ...
  Widget _banner(String msg,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          color: isError
              ? const Color(Constants.errorColor).withValues(alpha: 0.1)
              : Colors.green.shade50,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
              color: isError
                  ? const Color(Constants.errorColor).withValues(alpha: 0.3)
...
class _CorteCajaDialogState extends State<_CorteCajaDialog> {
  ...
  // ✅ Fix 1: helper de fecha seguro
  String _formatFecha(String fecha) {
    if (fecha.length >= 16) {
      return fecha.substring(0, 16).replaceAll('T', ' ');
    }
        ...
        children: [
          ...
          Container(
            ...
            child: Column(children: [
              ...
              _fila('Transferencia', r.ventas.transferencia,
                  Colors.purple.shade700),
              if (r.ventas.mixto > 0)
                _fila('Mixto', r.ventas.mixto, Colors.orange.shade700),
              const Divider(height: 16),
              _fila('TOTAL VENTAS', r.ventas.total, Colors.black87,
                  bold: true),
            ...
            child: r.gastos.detalle.isEmpty
                ...
                : Column(children: [
                    ...r.gastos.detalle.map((g) => _fila(
                        ...
                        negativo: true)),
                    const Divider(height: 16),
                    _fila('TOTAL GASTOS', r.gastos.total,
                        Colors.red.shade700,
          ...
          if (r.abonos.total > 0) ...[
            _tituloSeccion(
                '🔖 Abonos recibidos', Colors.teal.shade700),
            const SizedBox(height: 8),
            Container(
              padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(
              ...
              child: Column(children: [
                if (r.abonos.efectivo > 0)
                  _fila('Efectivo', r.abonos.efectivo,
                      Colors.teal.shade700),
                if (r.abonos.transferencia > 0)
                  _fila('Transferencia', r.abonos.transferencia,
                      Colors.teal.shade600),
                const Divider(height: 12),
                _fila('TOTAL ABONOS', r.abonos.total,
          ...
          _tituloSeccion(
              '💵 Cálculo de caja física', Colors.green.shade700),
          const SizedBox(height: 8),
          Container(
            padding: const EdgeInsets.all(14),
            decoration: BoxDecoration(
            ...
            child: Column(children: [
              ...
              _fila('+ Ventas efectivo', r.ventas.efectivo,
                  Colors.green.shade700),
              if (r.ventas.mixto > 0)
                _fila('+ Ventas mixto', r.ventas.mixto,
                    Colors.green.shade700),
              if (r.abonos.efectivo > 0)
                _fila('+ Abonos efectivo', r.abonos.efectivo,
                    Colors.teal.shade700),
              _fila('- Gastos efectivo', r.gastos.efectivo,
                  Colors.red.shade600,
                  negativo: true),
              const Divider(height: 16),
              _fila('ESPERADO EN CAJA', r.montoEsperadoCaja,
  ...
  Widget _buildPaso2(ResumenCierre r) => Column(
        ...
        children: [
          ...
          TextField(
            ...
            // ✅ Fix 3: formatter correcto para decimales
            inputFormatters: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              labelStyle: GoogleFonts.poppins(fontSize: 13),
              hintText:
                  'Ej: billetes contados, diferencias encontradas...',
  ...
  Widget _chipInfo(String label, String valor,
      ...
      Column(
        children: [
          Text(label,
              style:
                  GoogleFonts.poppins(color: labelColor, fontSize: 10)),
          Text(valor,
              style: GoogleFonts.poppins(
                  color: valorColor,
                  fontSize: 12,
        ...
        Container(
          ...
          child:
            ...
            Center(
              ...
              _mono('  CORTE DE CAJA #${r.sesionId}  ', Colors.black87,
                  bold: true),
            ...
            if (r.gastos.detalle.isEmpty)
              ...
              ...r.gastos.detalle
                  .map((g) => _rFila(g.categoria, '-${_f(g.monto)}')),
              _rDivider(),
              _rFila('TOTAL GASTOS', '-${_f(r.gastos.total)}',
                  bold: true),
            ],
            const SizedBox(height: 10),
            ...
            if (r.abonos.efectivo > 0)
              _rFila('+ Ef. abonos', '+${_f(r.abonos.efectivo)}'),
            _rFila('- Ef. gastos', '-${_f(r.gastos.efectivo)}'),
            _rDivider(),
            _rFila('ESPERADO EN CAJA', _f(r.montoEsperadoCaja),
                bold: true),
            const SizedBox(height: 10),
            ...
            Center(
                child:
                    _mono('── POS Multitienda ──', Colors.grey.shade400)),
          ]),
        ),
      ],
    );
